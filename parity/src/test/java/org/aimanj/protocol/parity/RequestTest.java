...
public class RequestTest extends RequestTester {
    ...
    public void testParityChangePassword() throws Exception {
        //CHECKSTYLE:OFF
        aiManj.parityChangePassword("0x407d73d8a49eeb85d32cf465507dd71d507100c1", "hunter2", "bazqux5").send();
    ...
    public void testParityDeriveAddressHash() throws Exception { 
        ...
        aiManj.parityDeriveAddressHash("0x407d73d8a49eeb85d32cf465507dd71d507100c1",
    ...
    public void testParityDeriveAddressIndex() throws Exception {               
        ...
        //CHECKSTYLE:OFF
        aiManj.parityDeriveAddressIndex("0x407d73d8a49eeb85d32cf465507dd71d507100c1", "hunter2", indexType, false).send();
    ...
    public void testParityExportAccount() throws Exception {
        aiManj.parityExportAccount("0x407d73d8a49eeb85d32cf465507dd71d507100c1", "hunter2").send();
    ...
    public void testParityGetDappAddresses() throws Exception {
        aiManj.parityGetDappAddresses("web").send();
    ...
    public void testParityGetDefaultDappAddress() throws Exception {
        aiManj.parityGetDappDefaultAddress("web").send();
    ...
    public void testParityGetNewDappsDefaultAddress() throws Exception {
        aiManj.parityGetNewDappsDefaultAddress().send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_getNewDappsDefaultAddress\","
                + "\"params\":[],\"id\":1}");
    }
    
    public void testParityImportGmanAccounts() throws Exception {
        ArrayList<String> gmanAccounts = new ArrayList<>();
        gmanAccounts.add("0x407d73d8a49eeb85d32cf465507dd71d507100c1");
        aiManj.parityImportGmanAccounts(gmanAccounts).send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_importGmanAccounts\","
                + "\"params\":[[\"0x407d73d8a49eeb85d32cf465507dd71d507100c1\"]],\"id\":1}");
    }
    
    public void testParityKillAccount() throws Exception {
        aiManj.parityKillAccount("0x407d73d8a49eeb85d32cf465507dd71d507100c1","hunter2").send();
    ...
    public void testParityListAccountsNoAccountOffsetNoBlockTag() throws Exception {
        ...
        aiManj.parityListAccounts(maxQuantityReturned, null, null).send();
    ...
    public void testParityListAccountsNoAccountOffsetWithBlockTag() throws Exception {
        ...
        aiManj.parityListAccounts(maxQuantityReturned, null, blockParameter).send();
    ...
    public void testParityListAccountsWithAccountOffsetWithBlockTag() throws Exception {
        ...
        aiManj.parityListAccounts(maxQuantityReturned,
    ...
    public void testParityListGmanAccounts() throws Exception {
        aiManj.parityListGmanAccounts().send();

        verifyResult("{\"jsonrpc\":\"2.0\",\"method\":\"parity_listGmanAccounts\","
                + "\"params\":[],\"id\":1}");
    }
    
    public void testParityListRecentDapps() throws Exception {
        aiManj.parityListRecentDapps().send();
    ...
    public void testParityNewAccountFromPhrase() throws Exception {
        aiManj.parityNewAccountFromPhrase("phrase", "password").send();
    ...
    public void testParityNewAccountFromSecret() throws Exception {
        //CHECKSTYLE:OFF
        aiManj.parityNewAccountFromSecret("0x1db2c0cf57505d0f4a3d589414f0a0025ca97421d2cd596a9486bc7e2cd2bf8b", "password").send();
    ...
    public void testParityNewAccountFromWallet() throws Exception {
        ...
        aiManj.parityNewAccountFromWallet(walletFile, "password").send();
    ...
    public void testParityRemoveAddress() throws Exception {
        aiManj.parityRemoveAddress("0x407d73d8a49eeb85d32cf465507dd71d507100c1").send();
    ...
    public void testParitySetAccountMeta() throws Exception {
        ...
        meta.put("foo", "bar");
        aiManj.paritySetAccountMeta("0xfc390d8a8ddb591b010fda52f4db4945742c3809", meta).send();
    ...
    public void testParitySetAccountName() throws Exception {
        aiManj.paritySetAccountName("0xfc390d8a8ddb591b010fda52f4db4945742c3809", "Savings")
                .send();
    ...
    public void testParitySetDappAddresses() throws Exception {
        ...
        aiManj.paritySetDappAddresses("web", dAppAddresses)
                .send();
    ...
    public void testParitySetDappDefaultAddress() throws Exception {
        aiManj.paritySetDappDefaultAddress("web", "0x407d73d8a49eeb85d32cf465507dd71d507100c1")
                .send();
    ...
    public void testParitySetNewDappsAddresses() throws Exception {
        ArrayList<String> dAppAddresses = new ArrayList<>();
        dAppAddresses.add("0x407d73d8a49eeb85d32cf465507dd71d507100c1");
        aiManj.paritySetNewDappsAddresses(dAppAddresses)
                .send();
    ...
    public void testParitySetNewDappsDefaultAddress() throws Exception {
        aiManj.paritySetNewDappsDefaultAddress("0x407d73d8a49eeb85d32cf465507dd71d507100c1")
                .send();
    ...
    public void testParityTestPassword() throws Exception {
        aiManj.parityTestPassword("0x407d73d8a49eeb85d32cf465507dd71d507100c1", "hunter2")
                .send();
    ...
    public void testParitySignMessage() throws Exception {
        //CHECKSTYLE:OFF
        aiManj.paritySignMessage("0xc171033d5cbff7175f29dfd3a63dda3d6f8f385e","password1","0xbc36789e7a1e281436464229828f817d6612f7b477d66591ff96a9e064bcc98a").send();
    ...
    public void testTraceBlock() throws Exception {
        aiManj.traceBlock(DefaultBlockParameterName.LATEST).send();
    ...
    public void testTraceFilter() throws Exception {
        aiManj.traceFilter(new TraceFilter(
