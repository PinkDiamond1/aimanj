...
import org.aimanj.protocol.core.methods.response.VoidResponse;
import org.aimanj.protocol.parity.methods.response.FullTraceInfo;
...
import org.aimanj.protocol.parity.methods.response.StateDiff;
import org.aimanj.protocol.parity.methods.response.Trace;
import org.aimanj.protocol.parity.methods.response.VMTrace;
...
public class ResponseTest extends ResponseTester {
    ...
    public void testParityFullTraceResponseTraces() {
        ...
        //CHECKSTYLE:OFF
        org.aimanj.protocol.parity.methods.response.Trace trace1 = new org.aimanj.protocol.parity.methods.response.Trace();
        ...
        org.aimanj.protocol.parity.methods.response.Trace trace2 = new org.aimanj.protocol.parity.methods.response.Trace();
        ...
        org.aimanj.protocol.parity.methods.response.Trace trace3 = new org.aimanj.protocol.parity.methods.response.Trace();
        ...
        org.aimanj.protocol.parity.methods.response.Trace trace4 = new org.aimanj.protocol.parity.methods.response.Trace();
        ...
        List<org.aimanj.protocol.parity.methods.response.Trace> traces = new ArrayList<>();
        traces.add(trace1);
        traces.add(trace2);
        traces.add(trace3);
        traces.add(trace4);
