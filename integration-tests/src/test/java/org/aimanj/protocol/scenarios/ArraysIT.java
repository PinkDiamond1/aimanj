...
import org.aimanj.generated.Arrays;
...
/**
 * Simple integration test to demonstrate arrays usage in aimanj.
 */
public class ArraysIT extends Scenario {
    ...
    public void setUp() throws Exception {
        super.setUp();
        this.contract = Arrays.deploy(aiManj, ALICE, new DefaultGasProvider()).send();
    }
