...
/**
 * Simple integration test to demonstrate sending of Man between parties.
 */
public class SendManIT extends Scenario {
    ...
    public void testTransferMan() throws Exception {
        ...
        Transaction transaction = Transaction.createManTransaction(
                ALICE.getAddress(), nonce, GAS_PRICE, GAS_LIMIT, BOB.getAddress(), value, "", "MAN",
                BigInteger.ZERO, BigInteger.ZERO, BigInteger.ZERO, null);
    ...
    public void testTransfer() throws Exception {
        TransactionReceipt transactionReceipt = Transfer.sendFunds(
                aiManj, ALICE, BOB.getAddress(), BigDecimal.valueOf(0.2), Convert.Unit.MAN)
                .send();
