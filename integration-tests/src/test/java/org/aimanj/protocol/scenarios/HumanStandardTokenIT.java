 ...
 * <a href="https://github.com/Matrix/EIPs/issues/20">EIP-20</a>. Solidity implementation is
...
public class HumanStandardTokenIT extends Scenario {
    ...
    private String sendCreateContractTransaction(
        ...
        ManSendTransaction transactionResponse = aiManj.manSendRawTransaction(hexValue)
                .sendAsync().get();
