...
public class HumanStandardToken extends Contract {
    ...
    @Deprecated
    protected HumanStandardToken(String contractAddress, aiManj aiManj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, aiManj, credentials, gasPrice, gasLimit);
    }

    protected HumanStandardToken(String contractAddress, aiManj aiManj, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, aiManj, credentials, contractGasProvider);
    }

    @Deprecated
    protected HumanStandardToken(String contractAddress, aiManj aiManj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, aiManj, transactionManager, gasPrice, gasLimit);
    }

    protected HumanStandardToken(String contractAddress, aiManj aiManj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> approveAndCall(String _spender, BigInteger _value, byte[] _extraData) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new org.aimanj.abi.datatypes.Address(_spender),
                new org.aimanj.abi.datatypes.generated.Uint256(_value),
                new org.aimanj.abi.datatypes.DynamicBytes(_extraData)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<HumanStandardToken> deploy(aiManj aiManj, Credentials credentials, ContractGasProvider contractGasProvider, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.aimanj.abi.datatypes.generated.Uint256(_initialAmount),
                new org.aimanj.abi.datatypes.Utf8String(_tokenName),
                new org.aimanj.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.aimanj.abi.datatypes.Utf8String(_tokenSymbol)));
        return deployRemoteCall(HumanStandardToken.class, aiManj, credentials, contractGasProvider, BINARY, encodedConstructor);
    }

    public static RemoteCall<HumanStandardToken> deploy(aiManj aiManj, TransactionManager transactionManager, ContractGasProvider contractGasProvider, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.aimanj.abi.datatypes.generated.Uint256(_initialAmount),
                new org.aimanj.abi.datatypes.Utf8String(_tokenName),
                new org.aimanj.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.aimanj.abi.datatypes.Utf8String(_tokenSymbol)));
        return deployRemoteCall(HumanStandardToken.class, aiManj, transactionManager, contractGasProvider, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<HumanStandardToken> deploy(aiManj aiManj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.aimanj.abi.datatypes.generated.Uint256(_initialAmount),
                new org.aimanj.abi.datatypes.Utf8String(_tokenName),
                new org.aimanj.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.aimanj.abi.datatypes.Utf8String(_tokenSymbol)));
        return deployRemoteCall(HumanStandardToken.class, aiManj, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<HumanStandardToken> deploy(aiManj aiManj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.aimanj.abi.datatypes.generated.Uint256(_initialAmount),
                new org.aimanj.abi.datatypes.Utf8String(_tokenName),
                new org.aimanj.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.aimanj.abi.datatypes.Utf8String(_tokenSymbol)));
        return deployRemoteCall(HumanStandardToken.class, aiManj, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
    ...
    @Deprecated
    public static HumanStandardToken load(String contractAddress, aiManj aiManj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new HumanStandardToken(contractAddress, aiManj, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static HumanStandardToken load(String contractAddress, aiManj aiManj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new HumanStandardToken(contractAddress, aiManj, transactionManager, gasPrice, gasLimit);
    }

    public static HumanStandardToken load(String contractAddress, aiManj aiManj, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new HumanStandardToken(contractAddress, aiManj, credentials, contractGasProvider);
    }

    public static HumanStandardToken load(String contractAddress, aiManj aiManj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new HumanStandardToken(contractAddress, aiManj, transactionManager, contractGasProvider);
    }
