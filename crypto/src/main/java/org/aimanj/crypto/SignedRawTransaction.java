...
public class SignedRawTransaction extends RawTransaction {
    ...
    public SignedRawTransaction(BigInteger nonce, BigInteger gasPrice,
            BigInteger gasLimit, String to, BigInteger value, String data, String currency,
            Sign.SignatureData signatureData, BigInteger txEnterType, BigInteger IsEntrustTx, BigInteger commitTime, List extra_to) {
        super(nonce, gasPrice, gasLimit, to, value, data, currency, txEnterType, IsEntrustTx, commitTime, extra_to);
