...
import static org.aimanj.codegen.FunctionWrapperGenerator.JAVA_TYPES_ARG;
import static org.aimanj.codegen.FunctionWrapperGenerator.SOLIDITY_TYPES_ARG;
import static org.aimanj.codegen.SolidityFunctionWrapperGenerator.COMMAND_GENERATE;
import static org.aimanj.codegen.SolidityFunctionWrapperGenerator.COMMAND_SOLIDITY;
import static org.aimanj.codegen.SolidityFunctionWrapperGenerator.getFileNameNoExtension;
...
public class SolidityFunctionWrapperGeneratorTest extends TempFileProvider {
    ...
    private void testCodeGeneration(List<String> prefixes,
        ...
        if (types.equals(JAVA_TYPES_ARG)) {
            packageName = "org.aimanj.unittests.java";
        } else if (types.equals(SOLIDITY_TYPES_ARG)) {
            packageName = "org.aimanj.unittests.solidity";
        }
