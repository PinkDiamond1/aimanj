...
public class TruffleJsonFunctionWrapperGenerator extends FunctionWrapperGenerator {
    ...
    public static class Contract {
         ...
         *
         * @param network the contract's address on this Matrix network
        ...
        /*
         * c.f., org.aimanj.tx.ChainId
         *
         * This should be updated with https://github.com/aiManj/aiManj/issues/234
         */
        enum Network {
            olympic(0),
