...
public class ENS extends Contract {
    ...
    @Deprecated
    protected ENS(String contractAddress, AiManj aiManj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, aiManj, credentials, gasPrice, gasLimit);
    }

    protected ENS(String contractAddress, AiManj aiManj, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, aiManj, credentials, contractGasProvider);
    }

    @Deprecated
    protected ENS(String contractAddress, AiManj aiManj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, aiManj, transactionManager, gasPrice, gasLimit);
    }

    protected ENS(String contractAddress, AiManj aiManj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> setSubnodeOwner(byte[] node, byte[] label, String owner) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new org.aimanj.abi.datatypes.generated.Bytes32(node),
                new org.aimanj.abi.datatypes.generated.Bytes32(label),
                new org.aimanj.abi.datatypes.Address(owner)),
    ...
    public RemoteCall<TransactionReceipt> setTTL(byte[] node, BigInteger ttl) {
        final Function function = new Function(
                FUNC_SETTTL, 
                Arrays.<Type>asList(new org.aimanj.abi.datatypes.generated.Bytes32(node),
                new org.aimanj.abi.datatypes.generated.Uint64(ttl)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setResolver(byte[] node, String resolver) {
        final Function function = new Function(
                FUNC_SETRESOLVER, 
                Arrays.<Type>asList(new org.aimanj.abi.datatypes.generated.Bytes32(node),
                new org.aimanj.abi.datatypes.Address(resolver)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<ENS> deploy(AiManj aiManj, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, aiManj, credentials, contractGasProvider, BINARY, "");
    }

    public static RemoteCall<ENS> deploy(AiManj aiManj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, aiManj, transactionManager, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<ENS> deploy(AiManj aiManj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, aiManj, credentials, gasPrice, gasLimit, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<ENS> deploy(AiManj aiManj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, aiManj, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public Flowable<NewOwnerEventResponse> newOwnerEventFlowable(ManFilter filter) {
        return aiManj.manLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewOwnerEventResponse>() {
            @Override
    ...
    public Flowable<NewResolverEventResponse> newResolverEventFlowable(ManFilter filter) {
        return aiManj.manLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewResolverEventResponse>() {
            @Override
    ...
    public Flowable<NewTTLEventResponse> newTTLEventFlowable(ManFilter filter) {
        return aiManj.manLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewTTLEventResponse>() {
            @Override
    ...
    @Deprecated
    public static ENS load(String contractAddress, AiManj aiManj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, aiManj, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ENS load(String contractAddress, AiManj aiManj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, aiManj, transactionManager, gasPrice, gasLimit);
    }

    public static ENS load(String contractAddress, AiManj aiManj, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, aiManj, credentials, contractGasProvider);
    }

    public static ENS load(String contractAddress, AiManj aiManj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, aiManj, transactionManager, contractGasProvider);
    }
