...
public interface AiManjRx {
     ...
     */
    Flowable<String> manBlockHashFlowable();
     ...
     */
    Flowable<String> manPendingTransactionHashFlowable();
     ...
     *         blockchain
     */
    Flowable<ManBlock> blockFlowable(boolean fullTransactionObjects);
     ...
     */
    Flowable<ManBlock> replayPastBlocksFlowable(
     ...
     *                              in the {@link ManBlock} responses
     ...
     */
    Flowable<ManBlock> replayPastAndFutureBlocksFlowable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
