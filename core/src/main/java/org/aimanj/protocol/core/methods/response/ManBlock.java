 ...
 * <ul>
 * <li>man_getBlockByHash</li>
 * <li>man_getBlockByNumber</li>
 * <li>man_getUncleByBlockHashAndIndex</li>
 * <li>manh_getUncleByBlockNumberAndIndex</li>
 * </ul>
 *
 * <p>See
 ...
 *
 * <p>See the following <a href="https://github.com/mancore/parity/issues/2401">issue</a> for
 * details on additional Parity fields present in ManBlock.</p>
 */
public class ManBlock extends Response<ManBlock.Block> {

    @Override
    @JsonDeserialize(using = ManBlock.ResponseDeserialiser.class)
    ...
    public static class Block {
        ...
        public Block(String number, String hash, String parentHash, String nonce,
                     ...
                     List<Map> stateRoot, String receiptsRoot, String author, String miner,
        ...
        public List<Map> getStateRoot() {
            return stateRoot;
        }

        public void setStateRoot(List<Map> stateRoot) {
            this.stateRoot = stateRoot;
        }
    ...
    public static class TransactionObject extends Transaction
        ...
        public TransactionObject(String hash, String nonce, String blockHash, String blockNumber,
            ...
            super(hash, nonce, blockHash, blockNumber, transactionIndex, from, to, value,
                    gasPrice, gas, input, publicKey, r, s, v, Currency, TxEnterType, CommitTime, IsEntrustTx,
                    matrixType, extra_to);
        }
            ...
            if (nextToken == JsonToken.FIELD_NAME) {
                ...
                for (String key:set) {
                    ...
                    for(int i = 0, length = list.size(); i < length;i++) {
                        if (list.get(i).getClass().toString().equals(new String().getClass().toString())) {
                            TransactionHash transactionHash = new TransactionHash();
                            transactionHash.setValue(String.valueOf(list.get(i)));
