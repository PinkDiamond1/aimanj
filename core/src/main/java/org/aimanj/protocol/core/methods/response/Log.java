...
/**
 * <p>Log object used by {@link ManLog} and {@link ManGetTransactionReceipt}.</p>
 * <p>It's not clear in the
 * <a href="https://github.com/matrix/wiki/wiki/JSON-RPC#man_newfilter">docs</a>
 * If only a list of hashes are returned for filters created with man_newBlockFilter or
 * man_newPendingTransactionFilter.</p>
 */
public class Log {
