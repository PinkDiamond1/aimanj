 ...
 */
public class ManSyncing extends Response<ManSyncing.Result> {

    @Override
    @JsonDeserialize(using = ManSyncing.ResponseDeserialiser.class)
    public void setResult(ManSyncing.Result result) {
    ...
    // these fields although not present in the RPC specification are returned by Gman 1.4.10
