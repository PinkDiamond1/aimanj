...
public class WalletFile {
    ...
    public static class Crypto {
        ...
        // To support my Gman Wallet keys uncomment this annotation & comment out the above
    ...
    // If we need to work with wallet we'll need to use this deserializer, see the
    // following issue https://github.com/kvhnuke/wallet/issues/269
