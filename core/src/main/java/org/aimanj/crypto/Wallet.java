...
/**
 * <p>Matrix wallet file management. For reference, refer to
 * <a href="https://github.com/Matrix/wiki/wiki/AiManj-Secret-Storage-Definition">
 * AiManj Secret Storage Definition</a> or the
 * <a href="https://github.com/Matrix/go-Matrix/blob/master/accounts/key_store_passphrase.go">
 * Go Matrix client implementation</a>.</p>
 *
 * <p><strong>Note:</strong> the Bouncy Castle Scrypt implementation
 * {@link SCrypt}, fails to comply with the following
 * Matrix reference
 * <a href="https://github.com/Matrix/wiki/wiki/AiManj-Secret-Storage-Definition#scrypt">
...
public class Wallet {
    ...
    private static WalletFile createWalletFile(
        ...
        String tempAddress = Keys.getAddress(ecKeyPair);

        String address = WalletUtils.getManAddress(tempAddress);
