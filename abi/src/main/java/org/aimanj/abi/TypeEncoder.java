...
import org.aimanj.abi.datatypes.BytesType;
...
import static org.aimanj.abi.datatypes.Type.MAX_BIT_LENGTH;
import static org.aimanj.abi.datatypes.Type.MAX_BYTE_LENGTH;

/**
 * <p>Matrix Contract Application Binary Interface (ABI) encoding for types.
