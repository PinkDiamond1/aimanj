 ...
 * This is so that we can pass around Typed {@link org.aimanj.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends org.aimanj.abi.datatypes.Type>
    ...
    public static <T extends org.aimanj.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends org.aimanj.abi.datatypes.Type>
