...
import org.aimanj.abi.datatypes.Array;
import org.aimanj.abi.datatypes.Bool;
import org.aimanj.abi.datatypes.Bytes;
...
import org.aimanj.abi.datatypes.FixedPointType;
import org.aimanj.abi.datatypes.Int;
import org.aimanj.abi.datatypes.IntType;
import org.aimanj.abi.datatypes.NumericType;
...
import org.aimanj.abi.datatypes.generated.Uint160;
import org.aimanj.utils.Numeric;

/**
 * <p>Matrix Contract Application Binary Interface (ABI) decoding for types.
 * Decoding is not documented, but is the reverse of the encoding details located
 * <a href="https://github.com/Matrix/wiki/wiki/Matrix-Contract-ABI">here</a>.
 * </p>
 */
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>) Class.forName(
                            "org.aimanj.abi.datatypes.generated.StaticArray" + length);
