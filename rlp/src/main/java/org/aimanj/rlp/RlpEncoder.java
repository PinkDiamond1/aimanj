...
import static org.aimanj.rlp.RlpDecoder.OFFSET_SHORT_LIST;
import static org.aimanj.rlp.RlpDecoder.OFFSET_SHORT_STRING;

/**
 * <p>Recursive Length Prefix (RLP) encoder.</p>
 *
 * <p>For the specification, refer to p16 of the <a href="http://gavwood.com/paper.pdf">
 * yellow paper</a> and <a href="https://github.com/Matrix/wiki/wiki/RLP">here</a>.</p>
 */
